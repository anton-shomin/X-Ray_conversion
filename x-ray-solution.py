...
test_case_updater.remove_header(dir)
test_case_updater.add_description(dir)
test_case_updater.clear_source(dir)
test_case_updater.summary_maker(dir)
test_case_updater.remove_prerequisites(dir)
test_case_updater.steps_creator(dir)
test_case_updater.steps_polisher(dir)
test_case_updater.steps_formatter(dir)
test_case_updater.steps_finalizer(dir)
